...
const SideMenu = ({ activeMenu }) => {
  ...
  return (
    <div className="w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/50 p-5 overflow-y-auto">
      <div className="flex flex-col items-center justify-center gap-3 mt-3 mb-7">
        ...
        <h5 className="text-gray-950 font-medium leading-6 text-center break-words">
          {user?.fullName || ""}
        </h5>
      </div>
